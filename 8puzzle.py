...
def solve_puzzle():
    for state in path:
        ...
        root.update()
        time.sleep(0.77)           # set the required time in seconds

    if puzzle_solved_var.get() == 0: 
        success_label.config(text="The puzzle is solved! \nBetter Luck next time!!", fg='red')
        pygame.mixer.music.load('C:/Users/LENOVO/Downloads/audio.mp3') 
        pygame.mixer.music.play()

def start_puzzle():
    puzzle_solved_var.set(0)
    pygame.mixer.music.load('C:/Users/LENOVO/Downloads/start_sound.mp3')  
    pygame.mixer.music.play()
    root.after(int(pygame.mixer.Sound('C:/Users/LENOVO/Downloads/start_sound.mp3').get_length() * 1000), solve_puzzle)

def stop_puzzle():
    puzzle_solved_var.set(1)
    success_label.config(text="Congratulations!! \nYou have won the Challenge", fg='green')
    pygame.mixer.music.load('C:/Users/LENOVO/Downloads/congratulations.mp3')  
    pygame.mixer.music.play()
